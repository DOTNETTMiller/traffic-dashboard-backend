...
-- PostgreSQL variant. The crash-data-service also creates this table on first
-- run (ensureTable), so running this migration is optional but documents the schema.
