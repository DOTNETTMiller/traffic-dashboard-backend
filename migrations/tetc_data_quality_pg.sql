...
('I95_CORR_od_personal_streetlight', 'I95_CORRIDOR', 'od_personal', 'StreetLight Data', 'TETC Data Marketplace', true),
('I95_CORR_od_freight_atri', 'I95_CORRIDOR', 'od_freight', 'ATRI', 'TETC Data Marketplace', true),
('I95_CORR_volume_inrix', 'I95_CORRIDOR', 'volume', 'INRIX', 'TETC Data Marketplace', true),

-- Delaware feeds
('I95_DE_probe_inrix', 'I95_DE', 'probe_travel_time', 'INRIX', 'TETC Data Marketplace', true),
('I95_DE_od_personal_replica', 'I95_DE', 'od_personal', 'Replica', 'TETC Data Marketplace', true),
('I95_DE_wzdx_deldot', 'I95_DE', 'work_zone', 'DelDOT', 'Delaware 511 WZDx', true),
('I95_DE_incident_deldot', 'I95_DE', 'incident', 'DelDOT', 'Delaware 511', true),
('I95_DE_truck_parking_tpims', 'I95_DE', 'truck_parking', 'DelDOT', 'TPIMS', true),

-- Maryland feeds
('I95_MD_probe_inrix', 'I95_MD', 'probe_travel_time', 'INRIX', 'TETC Data Marketplace', true),
('I95_MD_od_freight_atri', 'I95_MD', 'od_freight', 'ATRI', 'TETC Data Marketplace', true),
('I95_MD_wzdx_mdot', 'I95_MD', 'work_zone', 'MDOT', 'Maryland WZDx', true),
('I95_MD_incident_chart', 'I95_MD', 'incident', 'MDOT', 'CHART System', true),
('I95_MD_truck_parking_mdot', 'I95_MD', 'truck_parking', 'MDOT', 'TPIMS', true),

-- Virginia feeds
('I95_VA_probe_inrix', 'I95_VA', 'probe_travel_time', 'INRIX', 'TETC Data Marketplace', true),
('I95_VA_od_personal_replica', 'I95_VA', 'od_personal', 'Replica', 'TETC Data Marketplace', true),
('I95_VA_od_freight_atri', 'I95_VA', 'od_freight', 'ATRI', 'TETC Data Marketplace', true),
('I95_VA_wzdx_vdot', 'I95_VA', 'work_zone', 'VDOT', 'Virginia 511 WZDx', true),
('I95_VA_incident_vdot', 'I95_VA', 'incident', 'VDOT', 'Virginia 511', true),
('I95_VA_truck_parking_vdot', 'I95_VA', 'truck_parking', 'VDOT', 'TPIMS', true),

-- Pennsylvania feeds
('I95_PA_probe_inrix', 'I95_PA', 'probe_travel_time', 'INRIX', 'TETC Data Marketplace', true),
('I76_PA_probe_inrix', 'I76_PA', 'probe_travel_time', 'INRIX', 'TETC Data Marketplace', true),
('I76_PA_od_freight_atri', 'I76_PA', 'od_freight', 'ATRI', 'TETC Data Marketplace', true),
('I76_PA_truck_parking_penndot', 'I76_PA', 'truck_parking', 'PennDOT', 'TPIMS', true),

-- New Jersey feeds
('I95_NJ_probe_inrix', 'I95_NJ', 'probe_travel_time', 'INRIX', 'TETC Data Marketplace', true),
('I95_NJ_od_personal_streetlight', 'I95_NJ', 'od_personal', 'StreetLight Data', 'TETC Data Marketplace', true),
('I95_NJ_incident_njdot', 'I95_NJ', 'incident', 'NJDOT', 'New Jersey 511', true),

-- Iowa feeds (existing)
('I80_IA_probe_tt_inrix', 'I80_IA', 'probe_travel_time', 'INRIX', 'TETC Data Marketplace', true),
('I80_IA_od_personal_replica', 'I80_IA', 'od_personal', 'Replica', 'TETC Data Marketplace', true),
('I80_IA_od_freight_atri', 'I80_IA', 'od_freight', 'ATRI', 'TETC Data Marketplace', true),
('I80_IA_volume_blend', 'I80_IA', 'volume', 'Iowa DOT', 'Internal Blended', true),
('I80_IA_wzdx_ia511', 'I80_IA', 'work_zone', 'Iowa DOT', 'Iowa 511 WZDx', true),
...
INSERT INTO quality_scores (validation_run_id, acc_score, cov_score, tim_score, std_score, gov_score, dqi, letter_grade) VALUES
...
INSERT INTO metric_values (validation_run_id, metric_key, raw_value, unit, score_0_100, notes) VALUES
