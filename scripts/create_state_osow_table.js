...
const stateData = [
  ...
  // Additional NASCO Corridor States (partial data)
  {
    state_key: 'mo',
    state_name: 'Missouri',
    max_length_ft: 65,
    ...
    both_escorts: 0,
    is_nasco_state: 1,
    nasco_corridor_routes: JSON.stringify(['I-35', 'I-29', 'I-70']),
    nasco_special_provisions: 'NASCO corridor junction state - I-35 and I-29 converge in Kansas City',
    permit_office_phone: '573-751-2551',
    permit_office_email: 'motor.carrier@modot.mo.gov',
    permit_portal_url: 'https://www.modot.org/commercial-vehicle',
    regulation_url: 'https://www.modot.org/commercial-vehicle-permits',
    last_verified_date: null,
    data_completeness_pct: 20.0,
    notes: 'Partial data - needs completion by Missouri DOT'
  },
  {
    state_key: 'sd',
    ...
    both_escorts: 0,
    is_nasco_state: 1,
    nasco_corridor_routes: JSON.stringify(['I-29', 'I-90']),
    nasco_special_provisions: 'NASCO I-29 corridor state connecting to Canada',
    permit_office_phone: '605-773-3265',
    permit_office_email: null,
    permit_portal_url: 'https://dot.sd.gov/commercial',
    regulation_url: null,
    last_verified_date: null,
    data_completeness_pct: 15.0,
    notes: 'Partial data - needs completion by South Dakota DOT'
  },
  {
    state_key: 'nd',
    ...
    both_escorts: 0,
    is_nasco_state: 1,
    nasco_corridor_routes: JSON.stringify(['I-29', 'I-94']),
    nasco_special_provisions: 'Northern NASCO gateway - I-29 and I-94 to Canadian border',
    permit_office_phone: '701-328-2621',
    permit_office_email: null,
    permit_portal_url: 'https://www.dot.nd.gov/divisions/mv/oversize.htm',
    regulation_url: null,
    last_verified_date: null,
    data_completeness_pct: 15.0,
    notes: 'Partial data - needs completion by North Dakota DOT'
  },
  {
    state_key: 'mt',
    state_name: 'Montana',
    ...
    both_escorts: 0,
    is_nasco_state: 1,
    nasco_corridor_routes: JSON.stringify(['I-94', 'I-90']),
    nasco_special_provisions: 'Western terminus of NASCO I-94 corridor',
    permit_office_phone: '406-444-6130',
    permit_office_email: null,
    permit_portal_url: 'https://www.mdt.mt.gov/business/commercial-vehicle/',
    regulation_url: null,
    last_verified_date: null,
    data_completeness_pct: 15.0,
    notes: 'Partial data - needs completion by Montana DOT'
  },
  {
    state_key: 'wi',
    ...
    is_nasco_state: 1,
    nasco_corridor_routes: JSON.stringify(['I-94', 'I-90']),
    nasco_special_provisions: 'NASCO I-94 corridor state',
    permit_office_phone: '608-266-0976',
    permit_office_email: null,
    permit_portal_url: 'https://wisconsindot.gov/Pages/dmv/com-drv-vehi/mtr-car-trkr/default.aspx',
    regulation_url: null,
    last_verified_date: null,
    data_completeness_pct: 15.0,
    notes: 'Partial data - needs completion by Wisconsin DOT'
  },
  {
    state_key: 'il',
    state_name: 'Illinois',
    ...
    both_escorts: 0,
    is_nasco_state: 1,
    nasco_corridor_routes: JSON.stringify(['I-94', 'I-80', 'I-90']),
    nasco_special_provisions: 'NASCO I-94 corridor state',
    permit_office_phone: '217-782-6212',
    permit_office_email: null,
    permit_portal_url: 'https://www.ilsos.gov/departments/vehicles/commercial_vehicles/home.html',
    regulation_url: null,
    last_verified_date: null,
    data_completeness_pct: 15.0,
    notes: 'Partial data - needs completion by Illinois DOT'
  },
  {
    state_key: 'in',
    state_name: 'Indiana',
    ...
    both_escorts: 0,
    is_nasco_state: 1,
    nasco_corridor_routes: JSON.stringify(['I-94', 'I-80']),
    nasco_special_provisions: 'NASCO I-94 corridor state',
    permit_office_phone: '317-615-7200',
    permit_office_email: null,
    permit_portal_url: 'https://www.in.gov/indot/doing-business-with-indot/oversize-and-overweight-permits/',
    regulation_url: null,
    last_verified_date: null,
    data_completeness_pct: 15.0,
    notes: 'Partial data - needs completion by Indiana DOT'
  },
  {
    state_key: 'mi',
    state_name: 'Michigan',
    ...
    both_escorts: 0,
    is_nasco_state: 1,
    nasco_corridor_routes: JSON.stringify(['I-94', 'I-75']),
    nasco_special_provisions: 'Eastern NASCO gateway - Ambassador Bridge connects to Windsor, Ontario',
    permit_office_phone: '517-241-6830',
    permit_office_email: null,
    permit_portal_url: 'https://www.michigan.gov/mdot/travel/commercial/permits',
    regulation_url: null,
    last_verified_date: null,
    data_completeness_pct: 15.0,
    notes: 'Partial data - needs completion by Michigan DOT'
  }
];
